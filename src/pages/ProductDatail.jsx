...
//     {
//       // A: {
//       Name: lang === "th" ? "ข้าวหอมมะลิ 100% ขนาด 5 กก." : "",
//       Subtitles:
//         lang === "th"
//           ? " Lorem ipsum dolor sit amet consectetur adipisicing elit."
//           : "",

//       SaleBy: lang === "th" ? ": ข้าวเบญจรงค์" : "",
//       two: {
...
//             (product) => product.props[0] === selectedProducts
//           )
//         : ProductDetail
//     );
...
//               <h3 className="font-semibold">{ProductDetail[0].Name}</h3>
//               <p className="font-light text-gray-500">
//                 {ProductDetail[0].Subtitles}
//               </p>
//               <div>
//                 <p className="font-medium inline-block">
//                   {lang === "th" ? "ขายโดย" : ""}
//                 </p>{" "}
//                 <span>{ProductDetail[0].SaleBy} </span>
//               </div>
...
//                   {" "}
//                   {/* เอาราคา Price Price */}
//                   {filteredProducts[0]?.five.Price}
//                 </h1>
//                 <h2 className="text-red-500 line-through">
//                   {/* เอาราคา  Sale */}

//                   {/* {ProductDetail.A.Sale} */}
//                 </h2>
//                 <h4 className="bg-brown1 w-fit  text-white py-1 px-2  top-4 left-4  rounded-md">
//                   {/* เอาเปอร์เซ็น  percentSale*/}
//                   {/* {filteredProducts[0].five.Price} */}
//                   {/* {percentSale(ProductDetail.A.Price, ProductDetail.A.Sale)}% */}
//                   Off
//                 </h4>
//               </div>
//               <a
